...
export default function Browse() {
  ...
  useEffect(() => {
    loadRecipes();
  }, [followingOnly]); // eslint-disable-line react-hooks/exhaustive-deps
      ...
      <div className="container">
        <div className="search-panel">
          ...
          <div className="search-row">
            ...
            />
            <button className="btn" onClick={loadRecipes}>
              Search
            </button>
          </div>
          ...
          <div className="filter-section">
            ...
            <div className="filter-grid">
              <label className="filter-field">
                <span className="f-label">Ingredient</span>
                <input
                  type="text"
              ...
              <label className="filter-field">
                <span className="f-label">Utensil</span>
                <input
                  type="text"
              ...
              <label className="filter-field">
                <span className="f-label">Food type</span>
                <input
                  type="text"
              ...
              <label className="filter-field">
                <span className="f-label">Cuisine</span>
                <input
                  type="text"
          ...
          <div className="filter-section">
            ...
            <div className="filter-grid">
              <label className="filter-field">
                <span className="f-label">Max cost (₹)</span>
                <input type="number" value={cost} onChange={(e) => setCost(e.target.value)} />
              </label>
              <label className="filter-field">
                <span className="f-label">Max time (min)</span>
                <input type="number" value={time} onChange={(e) => setTime(e.target.value)} />
              </label>
              <label className="filter-field">
                <span className="f-label">Max calories</span>
                <input type="number" value={calories} onChange={(e) => setCalories(e.target.value)} />
              </label>
              <label className="filter-field">
                <span className="f-label">Dietary preference</span>
          ...
          <div className="filter-section">
            ...
            <div className="filter-grid">
              <label className="filter-field">
                <span className="f-label">Min speed ({minSpeed})</span>
                <input
                  type="range"
                  min="0"
                  max="5"
              ...
              <label className="filter-field">
                <span className="f-label">Min difficulty ({minDifficulty})</span>
                <input
                  type="range"
                  min="0"
                  max="5"
              ...
              <label className="filter-field">
                <span className="f-label">Min rating ({minRating})</span>
                <input
                  type="range"
                  min="0"
                  max="5"
        ...
        <div className="recipe-grid">
          {recipes === null ? (
            <div className="loading-state" style={{ gridColumn: "1 / -1" }}>
              <span className="spinner"></span> Loading recipes…
            </div>
          ) : recipes.length === 0 ? (
              ...
              <div key={r.id} className={`recipe-card ${r.recipe_type === "veg" ? "veg" : ""}`}>
                ...
                <div className="card-body">
                  <div className="author-row">
                    <Avatar
                      src={r.creator_profile_picture_url}
                      label={r.creator_username}
                      className="author-avatar"
                      emptyClassName="author-avatar-empty"
                    />
                  ...
                  <div className="meta">
                    ...
                    <span style={{ marginLeft: 8 }}>
                      Speed {r.speed}/5 · Difficulty {r.difficulty}/5
                    </span>
                  </div>
                  <StarRating average={r.average_rating} count={r.rating_count} />
                  <Link className="btn small" to={`/recipe/${r.id}`}>
                    Open recipe
                  </Link>
                </div>
              </div>
